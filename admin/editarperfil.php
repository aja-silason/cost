...
<br>
            ...
            <div class="meuperfil" id="meuperfil">
                ...
                <br><br>
                <p><?php echo$dados['nome']?></p><input type="submit" value="Editar Nome" class="bnteditnome">
                <br>
                <br>
                ...
                <p style="Width: 100%; text-align: center; ">jhwefrwegh w gjh g r gkjwkw r r h rjktnknktn3nkhrwebuew
                     ewewhjbubewubueuiewbl,jew
                      wjhwbbw w thbw</p><input type="submit" value="Editar Descrição" class="bnteditdesc">
                      <br>
                      <br>
                      <br>
                      <br>
