...
<div class="menuclass">
        ...
        <br>
            ...
            <h3 class="titutocorpo">Postagem Paga</h3>

            <form metho="post" action="processarpost.php" class="formcampo">
                <input type="file" required>
                <br>
                <input type="text" Placeholder="Nome do Desaparecido" required>
                <br>
                <input type="number" Placeholder="Idade do desaparecido" required>
                <br>
